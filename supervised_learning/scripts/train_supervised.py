...
# 定义保存路径
MODEL_SAVE_DIR = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'models', 'checkpoints')
...
def train_model(game_states, moves, num_epochs=50, batch_size=64, learning_rate=0.001):
    """训练模型的核心函数"""
    ...
    for epoch in range(num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            model_path = os.path.join(MODEL_SAVE_DIR, 'tetris_model_best.pth')
